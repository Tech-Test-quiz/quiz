                ...
                get(userRef).then((snapshot) => {
                    if (snapshot.exists()) {
                        ...
                        if (userData.email === unit && userData.Password === pass) {
                            ...
                            localStorage.setItem("username",nameid)
                            changingprofile();
                        } else {
...
toggleCheckbox1.addEventListener('change', function() {
  ...
  // navigations of quiz page

  let javabutton=document.getElementById("javabutton");
  javabutton.addEventListener("click",()=>{
    window.location.href="javaarray/index.html";
  })

  let javabasics1=document.getElementById("javabasics1");
  javabasics1.addEventListener("click",()=>{
    window.location.href="javabasics/index.html"
  })
